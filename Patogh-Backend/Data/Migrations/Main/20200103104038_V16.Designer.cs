            ...
            modelBuilder.Entity("PatoghBackend.Entity.Models.FavUserDorehami", b =>
                {
                    ...
                    b.HasIndex("DorehamiId", "UserId")
                        .IsUnique()
                        .HasFilter("[DorehamiId] IS NOT NULL AND [UserId] IS NOT NULL");
            ...
            modelBuilder.Entity("PatoghBackend.Entity.Models.ImageDorehami", b =>
                {
                    ...
                    b.HasIndex("DorehamiId", "ImageId")
                        .IsUnique()
                        .HasFilter("[DorehamiId] IS NOT NULL AND [ImageId] IS NOT NULL");
            ...
            modelBuilder.Entity("PatoghBackend.Entity.Models.TagDorehami", b =>
                {
                    ...
                    b.HasIndex("DorehamiId", "TagId")
                        .IsUnique()
                        .HasFilter("[DorehamiId] IS NOT NULL AND [TagId] IS NOT NULL");
